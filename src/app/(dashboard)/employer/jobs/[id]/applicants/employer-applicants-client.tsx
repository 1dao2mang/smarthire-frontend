...
export default function EmployerApplicantsClient({ jobId }: { jobId: string }) {
    ...
    const filteredApplicants = useMemo(() => {
        ...
        result.sort((a, b) => {
            if (sortBy === "score-desc") return b.aiAnalysis.matchScore - a.aiAnalysis.matchScore;
            if (sortBy === "score-asc") return a.aiAnalysis.matchScore - b.aiAnalysis.matchScore;
            if (sortBy === "date-desc") return new Date(b.appliedAt).getTime() - new Date(a.appliedAt).getTime();
            return 0;
        });
